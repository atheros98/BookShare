...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td><%if (filter != "Completed")
                            ...
                            <div class="table-data-feature">
                                <a href="<%=string.Format("Borrowing.aspx?filter=Completed&id={0}", i)%>"<button class="item"><i class="fa fa-thumbs-up"></i></button></a>
                            </div>
                            <%} %>
                            <%} %>
                        </td>
        ...
        <div id="myModal" class="modal" runat="server" visible="false">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btnRate"><a id="rate" href="<%=string.Format("Borrowing.aspx?trading={0}&point=1", trading.InnerText) %>" >Rate Now</a></button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function add(ths, sno) {
            ...
            rate.href = "Borrowing.aspx?trading=" + trading.innerText + "&point=" + ratepoint.innerText;
